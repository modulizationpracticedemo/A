...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/modulizationpracticedemo/A"
  ...
  s.author             = { "FWD" => "felixvanwu@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/modulizationpracticedemo/A.git", :tag => s.version.to_s }
